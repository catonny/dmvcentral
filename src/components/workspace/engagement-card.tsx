...
import { Clock, XIcon, CalendarPlus } from "lucide-react";
...
export function EngagementCard({ engagement, client, employeeMap, onRemoveUser, onScheduleMeeting }: EngagementCardProps) {
    ...
    return (
         <div ref={setNodeRef} style={style} {...attributes} {...listeners}>
            <Card className="touch-none bg-background hover:shadow-md flex flex-col hover:border-primary/80">
                 <Link href={`/workflow/${engagement.id}`} className="flex flex-col flex-grow">
                 ...
                 <CardFooter className="p-2 pt-0 flex justify-end">
                    <Button variant="ghost" size="sm" onClick={handleScheduleClick}>
