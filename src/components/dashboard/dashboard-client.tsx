...
export function DashboardClient() {
  ...
  React.useEffect(() => {
    const defaultWidgets: Widget[] = [
        ...
        { id: 'workload-distribution', title: 'Workload Distribution', description: 'Pending and unassigned engagements across the team.', component: WorkloadDistribution, condition: isPartner, defaultLayout: { x: 0, y: 4, w: 12, h: 10 } },
        { id: 'todo-section', title: 'To-Do List', description: 'Action items that require your attention.', component: TodoSection, condition: true, defaultLayout: { x: 0, y: 14, w: 12, h: 8 } },
    ];
